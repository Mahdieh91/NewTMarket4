    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('last_contact', models.DateTimeField(blank=True, null=True, verbose_name='آخرین تماس')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('interaction_type', models.CharField(choices=[('call', 'تماس'), ('email', 'ایمیل'), ('meeting', 'جلسه'), ('note', 'یادداشت')], max_length=20, verbose_name='نوع تعامل')),
