    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('category', models.CharField(choices=[('conversion', 'نرخ تبدیل'), ('retention', 'ماندگاری'), ('revenue', 'درآمد'), ('satisfaction', 'رضایت'), ('matching', 'موفقیت تطبیق')], max_length=20, verbose_name='دسته\u200cبندی')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('industry', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='industries.industrycategory', verbose_name='صنعت')),
            ],
            options={
