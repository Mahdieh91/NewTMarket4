    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('final_decision', models.CharField(choices=[('approved', 'تأیید برای انتشار'), ('conditional', 'تأیید مشروط'), ('needs_info', 'نیازمند تکمیل اطلاعات'), ('rejected', 'رد درخواست'), ('referred', 'ارجاع به ارزیاب تخصصی')], default='needs_info', max_length=20, verbose_name='تصمیم نهایی')),
