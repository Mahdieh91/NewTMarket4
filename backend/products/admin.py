...
class SupplyAdmin(admin.ModelAdmin):
                ...
                <div style="display: flex; align-items: center; gap: 10px; 
                    ...
                    <a href="{url}" target="_blank" download="{filename}" 
                       style="display: inline-flex; align-items: center; gap: 6px;
                              ...
                              hover:transform: translateY(-1px); hover:box-shadow: 0 4px 12px rgba(13,110,253,0.4);"
                       onmouseover="this.style.transform='translateY(-1px)'; this.style.boxShadow='0 4px 12px rgba(13,110,253,0.4)';"
    ...
    def documents_raw(self, obj):
        if obj.documents:
            try:
                pretty = json.dumps(obj.documents, indent=2, ensure_ascii=False)
                return format_html(
